...
Having emailed IPSA (who provded the data), it appears that these negative expenses arise when an MP has been refunded for an expense, and so in turn has the expense refunded.
